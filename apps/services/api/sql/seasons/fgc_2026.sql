...
ALTER TABLE "match_detail" ADD COLUMN approximateWildfireInRedSuppressionUnit INT NOT NULL DEFAULT 0;
ALTER TABLE "match_detail" ADD COLUMN approximateWildfireInBlueSuppressionUnit INT NOT NULL DEFAULT 0;
ALTER TABLE "match_detail" ADD COLUMN approximateWildfireInExtinguisher INT NOT NULL DEFAULT 0;
