...
import { IgnitingInnovation } from '@toa-lib/models/seasons';
...
export const RankingsReport: FC<
  RankingsReportProps<IgnitingInnovation.SeasonRanking> & {
    teams?: Team[];
...
> = ({ rankings, identifier, teams }) => {
  ...
  const renderRow = (r: IgnitingInnovation.SeasonRanking) => [
    r.rank,
    ...
    <>
      ...
      <Report name='Competing Teams'>
        <UpgradedTable
          data={dataSorted}
          headers={headers}
          rowKey={'teamKey' as keyof IgnitingInnovation.SeasonRanking}
          renderRow={renderRow}
        />
      </Report>
    </>
