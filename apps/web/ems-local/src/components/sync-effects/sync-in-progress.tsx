...
import { eventKeyAtom, matchAtom, tournamentKeyAtom } from "src/stores/state/index.js";
...
export const useSyncInProgress = () => {
  ...
  const {data: tournamentMatches} = useMatchesForTournament(currentEvent, currentTournament);
